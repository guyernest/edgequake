...
/// Default tuple delimiter (matches edgequake-pipeline's DEFAULT_TUPLE_DELIMITER).
const DEFAULT_TUPLE_DELIMITER: &str = "<|#|>";

/// Default completion delimiter (matches edgequake-pipeline's DEFAULT_COMPLETION_DELIMITER).
const DEFAULT_COMPLETION_DELIMITER: &str = "<|COMPLETE|>";
